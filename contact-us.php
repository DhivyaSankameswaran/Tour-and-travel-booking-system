...
{
	$receivermailid="dhivyashree2001ed@gmail.com";
                            ...
                            <div class="col-md-4">
                                <div class="contact-sidebar">
                                    ...
                                    <div class="widget widget-text">
                                        <h5 class="blog_main_title">Book Your Dream Vacay Today!</h5>
                                        <div class="border-bottom">
                                            <div class="text">
                                                <p>Free Friendly Travel Mood, India's leading online travel & Tourism company, has a profound understanding of Indian consumers travel needs and preferences. It offers a wide range of holiday packages in India, catering to various segments of travellers. </p>
                                            </div>
                                        </div>
                                    </div>
                                    <!-- Widget Text End-->
                                    ...
                                    <div class="widget widget-contact">
                                        ...
                                        <div class="border-bottom">
                                            <div class="text">
                                                <div class="mg_contact"><i class="fa fa-map-marker"></i><span>Free Friendly Travel Mood,</span>
                                                                                                             <span> Novel Tech Park, Opposite to 1 MG Mall, MG Road,</span> 
                                                                                                              <span> Erode-560042, Tamilnadu, India</span></div>
                                                <div class="mg_contact"><i class="fa fa-phone"></i><span>+91-9360353021</span></div>
